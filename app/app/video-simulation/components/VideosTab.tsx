    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div
          ...
          className="bg-white rounded-lg shadow-md overflow-hidden border-2 border-dashed border-gray-300 hover:border-gray-700 hover:shadow-xl transition-all duration-300 cursor-pointer group"
        >
          <div className="aspect-video bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center group-hover:from-gray-100 group-hover:to-gray-200 transition-all">
            <div className="text-center">
              <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gray-200 group-hover:bg-gray-400 flex items-center justify-center transition-all">
                <svg className="w-12 h-12 text-gray-400 group-hover:text-gray-800 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-4">
            <h3 className="text-lg font-semibold text-gray-600 group-hover:text-gray-900 text-center transition-colors">
              Upload Video
            </h3>
          ...
          >
            <div className="aspect-video bg-gray-200 flex items-center justify-center relative group">
              {video.thumbnail_url ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-200">
              ...
              {video.analysis && (
                <div className="mt-3 flex items-center space-x-2 text-xs text-gray-500">
                  {video.analysis.objects && video.analysis.objects.length > 0 && (
                    <span className="px-2 py-1 bg-gray-200 text-black rounded">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="space-y-3">
                        {selectedVideo.analysis.timeline.map((segment: TimelineSegment, idx: number) => (
                          <div
                            key={idx}
                            className="border-l-4 border-gray-800 pl-4 py-2 bg-gray-50 rounded-r"
                          >
