        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer">
              <span className="text-2xl font-bold text-black">db</span>
            ...
            <div className="flex items-center gap-4">
              ...
              {isAuthenticated && campaigns.length > 0 && (
                <select
                  ...
                  className="px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-gray-500"
                >
          ...
          {activeTab === 'campaign' && !selectedCampaign && (
            <div className="space-y-6">
              ...
              <div className="bg-black rounded-lg shadow-lg p-8 text-white">
                ...
                <p className="text-gray-300 text-lg">Create campaigns, set your goals, and track how your videos perform</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div
                  ...
                  className="bg-white rounded-lg shadow-lg p-6 border-2 border-dashed border-gray-300 hover:border-gray-900 transition-all cursor-pointer flex flex-col items-center justify-center min-h-[300px] group"
                >
                ...
                {campaigns.map((camp) => (
                  <div
                    key={camp._id}
                    className="bg-white rounded-lg shadow-lg p-6 border-2 border-gray-200 hover:border-gray-900 hover:shadow-xl transition-all min-h-[300px] flex flex-col"
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="px-3 py-1 bg-gray-200 text-gray-800 text-xs font-semibold rounded-full">Active</div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="grid grid-cols-3 gap-2">
                        <button
                          ...
                          className="px-3 py-2 bg-black hover:bg-gray-800 text-white rounded-lg font-semibold transition-colors text-sm"
                        >
                          ✏️ Edit
                        </button>
                        <button
                          onClick={() => setSelectedCampaign(camp._id)}
                          className="px-3 py-2 bg-white hover:bg-gray-50 text-gray-900 border-2 border-gray-900 rounded-lg font-semibold transition-colors text-sm"
                        >
                          👁️ View
                        </button>
                        <button
                          ...
                          className="px-3 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded-lg font-semibold transition-colors text-sm"
                        >
                          🗑️ Delete
                        </button>
                      </div>
          ...
          {activeTab === 'campaign' && selectedCampaign && (
            <div className="space-y-6">
              ...
              <button
                ...
                className="flex items-center gap-2 text-gray-900 hover:text-black font-semibold"
              >
